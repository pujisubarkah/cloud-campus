...
<template>
  <header class="w-full bg-white shadow flex items-center justify-between px-8 py-3 fixed top-0 left-0 z-50">
    <!-- Logo & Sidebar Toggle -->
    <div class="flex items-center gap-4">
      ...
      <NuxtLink to="/" class="flex items-center gap-2">
        <img src="https://cloudcampus.hbmsu.ac.ae/pluginfile.php/1/core_admin/logocompact/300x300/1750320906/cloud-campus-logo-white3affadb508be04d6e8ec1b7d4aa3052c6e6881bf62c6d68a8e0c9575eb5bd78a%202.png" alt="Cloud Campus" class="h-8 w-auto" />
      </NuxtLink>
    </div>
    ...
    <div class="flex items-center gap-4">
      ...
      <button class="relative btn btn-sm btn-ghost text-gray-700 hover:bg-blue-100">
        <Bell class="w-6 h-6" />
      ...
      <div class="relative" @mouseenter="open = true" @mouseleave="open = false">
        <button class="flex items-center gap-2 btn btn-sm btn-ghost">
          <img src="https://ui-avatars.com/api/?name=Instructor&background=random" alt="Instructor" class="w-8 h-8 rounded-full" />
          <span class="hidden md:inline-block text-gray-700">Instructor</span>
        ...
        <div v-if="open" class="absolute right-0 w-48 mt-2 bg-white rounded-md shadow-lg z-50">
          ...
          <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-100">Logout</a>
        </div>
      </div>
    </div>
  </header>
